...
+ (void)showInAppRootWithText:(NSString *)contentString {
    AppDelegate *appDelegate = (AppDelegate *)[[UIApplication sharedApplication] delegate];
    [MBProgressHUD showHUDAddedTo:appDelegate.window.rootViewController.view
                   withDetailText:contentString
                         animated:YES];
}
...
+ (MB_INSTANCETYPE)showHUDAddedTo:(UIView *)view
                   withDetailText:(NSString *)detailString
                         animated:(BOOL)animated {
	MBProgressHUD *hud = [[self alloc] initWithView:view];
